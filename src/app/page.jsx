...
const Homepage = () => { 
  ...
  return (
    ...
    <div className="flex flex-col lg:flex-row lg:gap-x-20 justify-center items-center px-4 sm:px-8 md:12 lg:px:20 xl:px:48">
      <div className="h-1/2 lg:w-[50%] lg:mt-20 lg:h-full">
        <div className="place-self-center text-center lg:text-left">
          ...
          <p className="text-indigo-600 font-semibold text-base sm:text-xl md:text-xl lg:text-2xl mb-4">
            Welcome to my website! As a dedicated web developer, I am committed
            to crafting innovative projects that enhance user interface and
            experience.
          </p>
      ...
      <div className="h-1/2 justify-center lg:mt-20 lg:ml-20 lg:h-full lg:justify-center items-center lg:w-[50%]">
